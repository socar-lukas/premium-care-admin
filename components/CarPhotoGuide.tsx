      ...
      <div className="aspect-square bg-gray-50 relative">
        {photoCount > 0 ? (
          <div className="w-full h-full relative">
            ...
            {/* 추가/삭제 버튼 - 모바일에서 작게, 데스크탑에서 크게+중앙 */}
            <div className="absolute top-0 right-0 md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 flex gap-0 md:gap-3">
              <button
                ...
                className="w-[12px] h-[12px] md:w-8 md:h-8 bg-blue-500/80 text-white rounded-full flex items-center justify-center text-[9px] md:text-lg font-bold leading-none"
                title="사진 추가"
              >
                +
              </button>
              <button
                ...
                className="w-[12px] h-[12px] md:w-8 md:h-8 bg-red-500/80 text-white rounded-full flex items-center justify-center"
                title="삭제"
              >
                <svg className="w-[6px] h-[6px] md:w-4 md:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            {compressing ? (
              ...
              <>
                ...
                <div className="w-3 h-3 md:w-8 md:h-8 bg-blue-500 text-white rounded-full flex items-center justify-center">
            ...
            {previewUrls.map((url, index) => (
              <div key={index} className="relative aspect-square rounded-lg overflow-hidden border border-gray-200">
                ...
                <button
                  ...
                  className="absolute top-0 right-0 w-[12px] h-[12px] md:w-6 md:h-6 bg-red-500/80 text-white rounded-full flex items-center justify-center"
                >
                  <svg className="w-[6px] h-[6px] md:w-3 md:h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" />
                  </svg>
                </button>
              </div>
